...
public class NasalNewLayerImpl extends ASTWrapperPsiElement implements NasalNewLayer {

  public NasalNewLayerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NasalVisitor visitor) {
    visitor.visitNewLayer(this);
  }
  ...
  @Override
  @NotNull
  public List<NasalFullExpression> getFullExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NasalFullExpression.class);
  }
