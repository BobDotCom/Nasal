...
public class NasalForindexExprImpl extends ASTWrapperPsiElement implements NasalForindexExpr {

  public NasalForindexExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NasalVisitor visitor) {
    visitor.visitForindexExpr(this);
  }
