...
public class NasalIfExprImpl extends ASTWrapperPsiElement implements NasalIfExpr {

  public NasalIfExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NasalNewLayer> getNewLayerList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NasalNewLayer.class);
  }
